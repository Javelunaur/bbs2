 ...
 * @author Lenovo
 */
public class h_createprop extends javax.swing.JFrame {

    /**
     * Creates new form h_createprop
     */
    public h_createprop() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        addPANE.add(fn, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 220, 110, 30));
        ...
        addPANE.add(u_location, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 70, 320, 30));

        u_status.setFont(new java.awt.Font("Trebuchet MS", 1, 11)); // NOI18N
        u_status.setForeground(new java.awt.Color(134, 163, 194));
        u_status.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "/night", "/day" }));
        ...
        addPANE.add(u_status, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 220, 70, 30));
        ...
        addPANE.add(mn, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 20, 150, 30));
        ...
        fn1.setBackground(new java.awt.Color(243, 234, 234));
        fn1.setAlignmentX(0.0F);
        fn1.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(146, 80, 80)));
        fn1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                fn1ActionPerformed(evt);
            }
        });
        addPANE.add(fn1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 20, 150, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(h_createprop.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new h_createprop().setVisible(true);
            }
        });
    }
